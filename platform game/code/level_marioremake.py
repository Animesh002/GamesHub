import pygame 
from support_marioremake import import_csv_layout, import_cut_graphics
from settings_marioremake import tile_size, screen_height, screen_width
from tiles_marioremake import Tile, StaticTile, Crate, Coin, Palm
from enemy_marioremake import Enemy
from decoration_marioremake import Sky, Water, Clouds
from player_marioremake import Player
from particles_marioremake import ParticleEffect
from game_datamarioremake import levels
		...
		for row_index, row in enumerate(layout):
			for col_index,val in enumerate(row):
				if val != '-1':
					...
					if type == 'coins':
						if val == '0': sprite = Coin(tile_size,x,y,'assets/graphics/coins/gold',5)
						if val == '1': sprite = Coin(tile_size,x,y,'assets/graphics/coins/silver',1)
