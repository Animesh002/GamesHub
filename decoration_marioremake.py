from settings_marioremake import vertical_tile_number, tile_size, screen_width
import pygame
from tiles_marioremake import AnimatedTile, StaticTile
from support_marioremake import import_folder
